...
![5eb364cc5732428c695e2aa90138b01b.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18et2oej30dw04iglu.jpg)
...
- 特征缩放：我们要保证这些特征都具有相近的尺度，这将帮助梯度下降算法更快地**收敛**。最简单的方法是令：$x_{n}=\frac{x_{n}-\mu_{n}}{s_{n}}$，其中 ${\mu_{n}}$是平均值，${s_{n}}$是标准差。
  ![](https://ws3.sinaimg.cn/large/006tKfTcgy1g0ig13kakcj30go09igo7.jpg)
...
![6590923ac94130a979a8ca1d911b68a3.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e183m3xpj30go03q74d.jpg )

上述模型的表示可以理解为决策边界：
![f71fb6102e1ceb616314499a027336dc.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e186ll86j305k04pt8s.jpg )
...
![197d605aa74bee1556720ea248bab182.jpg](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e1888wn2j306p04zdfx.jpg )
...
> ![8b94e47b7630ac2b0bcb10d204513810.jpg](https://ws1.sinaimg.cn/large/006tKfTcgy1g1e1beki1qj30go04wweo.jpg)
...
![ffa56adcc217800d71afdc3e0df88378.jpg](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e18hkusej30b40593yi.jpg )
...
问题如下
![54d7903564b4416305b26f6ff2e13c04.png](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e18a16dwj30b405lt8v.jpg )
...
回归问题如下：
![72f84165fbf1753cd516e65d5e91c0d3.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e187qm93j30kc05e74p.jpg )

分类问题如下：
![be39b497588499d671942cc15026e4a2.jpg](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e189nlk3j30je05vjs7.jpg )
...
效果如下：
![ea76cc5394cf298f2414f230bcded0bd.jpg](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e18dt1s3j308c06rq35.jpg )
...
3. 求解方法-正规方程
   ![71d723ddb5863c943fcd4e6951114ee3.png](https://ws1.sinaimg.cn/large/006tKfTcgy1g1e18bic26j308c023745.jpg)
...
![6167ad04e696c400cb9e1b7dc1e58d8a.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18cyy28j30b005gaa4.jpg )

### 模型

![8293711e1d23414d0a03f6878f5a2d91.jpg](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e18ihothj30de089gmi.jpg )
...
矩阵表示为：
![20171101224053.png](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e189d0o6j30az03jt8m.jpg)
即：$\theta \cdot X=a​$

### FORWARD PROPAGATION

每一层的计算方法如下
![2e17f58ce9a79525089a1c2e0b4c0ccc.png](https://ws1.sinaimg.cn/large/006tKfTcgy1g1e18edlafj30fx02dq39.jpg )
...
![2ea8f5ce4c3df931ee49cf8d987ef25d.jpg](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e18dfiwnj30hw09sq46.jpg)
...
![432c906875baca78031bd337fe0c8682.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18b2n4rj30fb07bdg4.jpg )

### 多分类问题

上面的模型的输出层只有一个神经元。如果多分类，如4分类可以输出层4个神经元分别用来表示4类
![f3236b14640fa053e62c73177b3474ed.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18jozh6j30b403st97.jpg )
其中输出层的值可能如下：
![685180bf1774f7edd2b0856a8aae3498.png](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e18h2vo2j30jv03jwew.jpg )

### cost function

我们定义神经网络如下：
![8f7c28297fc9ed297f42942018441850.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18cg55jj30k8085gn6.jpg )
...
分析下面的反向传播过程
![6a0954ad41f959d7f272e8f53d4ee2de.jpg](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e18lw8xuj30af07saau.jpg )
以一次过程过程（一个样本）为例：
...
![5514df14ebd508fd597e552fbadcf053.jpg](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e184kirsj30go04tglw.jpg )
...
3. 使用60%的数据作为训练集，使用 20%的数据作为交叉验证集，使用20%的数据作为测试集
   ![7cf1cd9c123a72ca4137ca515871689d.png](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e1be00cdj308c07yt95.jpg )
...
下面的图就可以理解偏差方差：
![20c6b0ba8375ca496b7557def6c00324.jpg](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e185g5pzj30ju075aap.jpg )
...
1. 如何判断：将训练集代价函数$J_{train}$和交叉验证集的代价函数$J_{cv}$误差与多项式的次数绘制在同一张图表上来帮助分析（注意横轴是模型复杂度，从小到大）：
   ...
   - 交叉验证集误差远大于训练集误差时：方差/过拟合
     ![25597f0f88208a7e74a3ca028e971852.png](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e18kcr7ij30go097myk.jpg)
2. 当**使用正则化来代控制模型复杂度**时，如何选择，绘制$J_{train}$与$J_{cv}$图（注意横轴是$\lambda$ ,越大，模型复杂度月低，与上图相反）
   - 当 $\lambda$ 较小时，训练集误差较小（过拟合）而交叉验证集误差较大
   - 随着 $\lambda$ 的增加，训练集误差不断增加（欠拟合），而交叉验证集误差则是先减小后增加
     ![38eed7de718f44f6bb23727c5a88bf5d.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18kvx94j30go09ejsb.jpg)
3. 另一种判断方法是使用**学习曲线（Learning Curves）**，他是一种快速的合理性检验方法（sanity check）。他也是绘制绘制$J_{train}$与$J_{cv}$图，但是横轴是数据训练集大小m。思想是：当训练较少行数据的时候，训练的模型将能够非常完美地适应较少的训练数据，但是训练出来的模型却不能很好地适应交叉验证集数据或测试集数据
   - 识别高偏差/欠拟合：作为例子，我们尝试用一条直线来适应下面的数据，可以看出，无论训练集有多么大，误差都不会有太大改观（竖轴值都很大，且两者接近），此时再收集样本没什么用。
     ![4a5099b9f4b6aac5785cb0ad05289335.jpg](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e18lak4hj30go09nq3h.jpg)
   - 识别高方差/过拟合：假设我们使用一个非常高次的多项式模型，并且正则化非常小，可以看出，当交叉验证集误差远大于训练集误差时（竖轴值都小，前两者分开），往训练集增加更多数据可以提高模型的效果
     ![2977243994d8d28d5ff300680988ec34.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e1bfv3gsj30go09oq3f.jpg)
...
- trade-off: 一种方法是计算**F1 值**（**F1 Score**），${F}_{1}Score:2\frac{PR}{P+R}$
  ![84067e23f2ab0423679379afc6ed6caf.png](https://ws3.sinaimg.cn/large/006tKfTcgy1g1e188nzrkj306r078mxd.jpg)
...
![befe860fd4b1aef2f6eebf617baf5877.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e187b4afj308i076dg0.jpg )
...
![5a63e35db410fdb57c76de97ea888278.png](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e185wsy5j30dw05j0sw.jpg )

理解：**从逻辑回归演变而来**
![59541ab1fda4f92d6f1b508c8e29ab1c.png](https://ws1.sinaimg.cn/large/006tKfTcgy1g1e18bxhqwj30go08uq4c.jpg )
注意点：
...
1. 当我们把$C$设置成了非常大的常数，我们将会很希望找到一个使第一项为0的最优解。因此，如果 $y^{(i)}$是等于1，那么需要$\theta^Tx^{(i)}>=1$， 如果 $y^{(i)}$是等于0，那么需要$\theta^Tx^{(i)}<=-1$。这两个约束条件总结如下：
   ![](https://ws4.sinaimg.cn/large/006tKfTcgy1g14nc0wirhj308c0423z1.jpg)
2. 决策边界的效果如下，黑色的线优于绿色，他具有最大的间隔：
   ![e68e6ca3275f433330a7981971eb4f16.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18i1h7dj30b407daah.jpg)
3. 理解为何上述约束会生成黑色的线
   ...
   - 下图中左边的投影（红色）比较小（p小），为了>=1则$\theta$则比较大，对比右图，会发现他的$\theta$比较小，**对应的图中间隔比较大**
     ![](https://ws2.sinaimg.cn/large/006tKfTcgy1g14osbzp5zj30go09e42h.jpg)
...
4. 映射的方法：对每个样本计算m个新特征：$f_{1}=\operatorname{similarity}\left(x, l^{(1)}\right)=e\left(-\frac{\left\|x-l^{(1)}\right\|^{2}}{2 \sigma^{2}}\right)$，分别计算$f_1,f_2...f_m$。这里的$l^{(1)}$是样本集合中的一个其他样本，叫做**地标**，$f_i$刻画了与$l^{(i)}$的相似距离。这里的similarity就是核函数，这个叫高斯核
   ![](https://ws1.sinaimg.cn/large/006tKfTcgy1g14pper49zj30go08sae9.jpg)
...
1. 为什么这种映射是可行的？感性的理解一下，样本空间如下，当样本处于洋红色的点位置处，因为其离$l^{(1)}$更近，但是离$l^{(2)}$和$l^{(3)}$较远，因此$f_1$接近1，而$f_2$,$f_3$接近0。因此$h_θ(x)=θ_0+θ_1f_1+θ_2f_2+θ_1f_3>0$，因此预测$y=1$。同理可以求出，对于离$l^{(2)}$较近的绿色点，也预测$y=1$，但是对于蓝绿色的点，因为其离三个地标都较远，预测$y=0$。
   ![](https://ws4.sinaimg.cn/large/006tKfTcgy1g14pgjrpmmj30dw04rweh.jpg)
2. 高斯核的作用？高斯核的图像如下，可以发现：
   ...
   ![](https://ws1.sinaimg.cn/large/006tKfTcgy1g14pofkjsej30go096dg2.jpg)
...
![](https://ws3.sinaimg.cn/large/006tKfTcgy1g15wve1wa4j308c01edfs.jpg)
...
![](https://ws3.sinaimg.cn/large/006tKfTcgy1g15x744odwj30go08habp.jpg)
...
![](https://ws2.sinaimg.cn/large/006tKfTcgy1g15xg2rlxyj308c06lt8k.jpg)

> 对比线性回归目标不同，方法相似，线性回归目标是预测，这里没有.
> 投射的方向不同，如下所示，左边的是线性回归的误差（垂直于横轴投影），右边则是主要成分分析的误差（垂直于红线投影）
> ![](https://ws3.sinaimg.cn/large/006tKfTcgy1g15xilfkobj30dw05qq34.jpg)
...
3. 第三步是计算协方差矩阵$Σ$的**特征向量**（**eigenvectors**）:在Octave中用svd方法
   ![0918b38594709705723ed34bb74928ba.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e1bffe7mj30b403uaa7.jpg )
...
![65afdea865d50cba12d4f7674d599de5.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18g5yhlj308c04yaa9.jpg )
模型定义：
...
![ba47767a11ba39a23898b9f1a5a57cc5.png](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e1bdk5hxj30kc08mt97.jpg )
$p(x)$的图像如下
![82b90f56570c05966da116c3afe6fc91.jpg](https://ws2.sinaimg.cn/large/006tKfTcgy1g1e18gngicj30by08zaal.jpg )
...
![](https://ws4.sinaimg.cn/large/006tKfTcly1g1699p4ovdj30ho05kjre.jpg)
...
2. 不独立的特征：我们经常发现模型一些异常的数据可能也会有较高的$p(x)$值，这个可能是特征有了问题，一般会使用**误差分析**的方法，发现一些新的特征--通常可以通过**将一些相关特征进行组合**，来获得一些新的更好的特征。（简而言之把不独立的特征组合形成一个特征消除了不独立的问题）
   ![](https://ws1.sinaimg.cn/large/006tKfTcly1g169ee119sj30go09en08.jpg)

### 多元高斯分布

解决特征相关的问题一个更『高级』的方法是使用多元高斯分布，他的分布如下图蓝色所示：是**一个歪的椭圆**
![](https://ws3.sinaimg.cn/large/006tKfTcly1g169gbo45vj308c06swgk.jpg)
...
![](https://ws1.sinaimg.cn/large/006tKfTcly1g169h0o31vj30r2090q3l.jpg)
上图是5个不同的模型，从左往右依次分析：
...
多元高斯分布应用过程如下：
![](https://ws4.sinaimg.cn/large/006tKfTcly1g169op6b12j30go09kgpg.jpg)
...
![](https://ws3.sinaimg.cn/large/006tKfTcgy1g17wzyatlaj308c06m3yn.jpg)
...
![](https://ws3.sinaimg.cn/large/006tKfTcgy1g17x9ozj3jj30fw08v0t1.jpg)
...
问题：识别图片中包含的所有文字
![095e4712376c26ff7ffa260125760140.jpg](https://ws4.sinaimg.cn/large/006tKfTcgy1g1e18amvdlj30go0a5wg3.jpg )
...
3. 字符分类（**Character classification**）——确定每一个字符是什么
   ...
   ![](https://ws2.sinaimg.cn/large/006tKfTcgy1g17xqa5tw2j30go01qdfu.jpg)
...
> ![](https://ws2.sinaimg.cn/large/006tKfTcgy1g17xwwfdm8j30b407u0ss.jpg)
...
效果如下（绿色为最终有效区域）
![](https://ws1.sinaimg.cn/large/006tKfTcgy1g17xwfodlvj30b506yglj.jpg)
...
![](https://ws2.sinaimg.cn/large/006tKfTcgy1g17xzh9hbgj30b403mq2t.jpg)
![](https://ws1.sinaimg.cn/large/006tKfTcgy1g17xzno5rxj308c01gglf.jpg)
...
![](https://ws2.sinaimg.cn/large/006tKfTcly1g18i74u71aj30ar03a74d.jpg)